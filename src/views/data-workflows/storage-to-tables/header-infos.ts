...
export default class HeaderInfos extends Vue {
	get workflowName() {
		return STORAGE_TO_TABLES.displayName;
	}

	get tabsItems() {
		return [
			{ id: 1, title: 'Runs', link: { name: STORAGE_TO_TABLES_RUNS_LISTING } },
			{ id: 2, title: 'Configurations', link: { name: STORAGE_TO_TABLES_CONFIGURATIONS_LISTING } },
